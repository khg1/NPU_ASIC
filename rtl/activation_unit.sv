...
// LUT content is a compile-time constant (generated by LUT/gelu.py /
// LUT/sigmoid.py alongside the .hex files) instead of a $readmemh file
// load, so it synthesizes as ordinary constant-driven logic on ASIC
// flows and needs no elaboration-time file path.
logic signed [LUT_WIDTH-1:0] lut_gelu 		[0:LUT_DEPTH-1] = '{
`include "../LUT/lut/gelu_q88.svh"
};
logic signed [LUT_WIDTH-1:0] lut_sigmoid	[0:LUT_DEPTH-1] = '{
`include "../LUT/lut/sigmoid_q88.svh"
};
